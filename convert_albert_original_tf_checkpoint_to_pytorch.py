...
if __name__ == "__main__":
    ...
    parser.add_argument("--tf_checkpoint_path",
                        default = "./pretrained_models/albert_tiny/checkpoint",
                        type = str,
                        required = False,
                        help = "Path to the TensorFlow checkpoint path.")
    parser.add_argument("--albert_config_file",
                        default ="./pretrained_models/albert_tiny/albert_config_tiny_g.json",
                        type = str,
                        required = False,
                        help = "The config json file corresponding to the pre-trained ALBERT model. \n"
                            "This specifies the model architecture.")
    parser.add_argument("--pytorch_dump_path",
                        default ="./pretrained_models/albert_tiny/albert_tiny.bin",
                        type = str,
                        required = False,
